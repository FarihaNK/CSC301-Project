...
// //VERSION 10.2: ALL FIXED UP ATTEMPT 2: THIS WORKS 100% I THINK IDK BUT YEAH 
...
// //INTEGRATED VERSION OF THE THING : 
...
// // import "./upload.css";
// // import logo from "../assets/logo.png";
// // import ChatbotInterface from "./ChatbotInterface"; // Import your chatbot component

// // const Documents = () => {
// //   // State for switching between Upload and Chatbot interfaces
// //   const [showChatbot, setShowChatbot] = useState(false);

// //   // Documents from server (for upload page)
// //   const [documents, setDocuments] = useState([]);

// //   // Modals
// //   const [showModal, setShowModal] = useState(false);      // For upload form modal
// //   const [previewModal, setPreviewModal] = useState(false); // For file preview modal
...
// //   // ========== Render ==========
// //   if (showChatbot) {
// //     // Render the ChatbotInterface when showChatbot is true
// //     return (
// //       <div>
// //         <button onClick={() => setShowChatbot(false)}>Back to Upload</button>
// //         <ChatbotInterface />
// //       </div>
// //     );
// //   }
...
// //             <li>Patients</li>
// //             <li>Schedule</li>
// //             {/* Add a menu item to switch to chatbot */}
// //             <li onClick={() => setShowChatbot(true)} style={{ cursor: "pointer" }}>
// //               MedAssistant
// //             </li>
// //             <li>Personal Profile</li>
// //             <li>Settings</li>
...
// //VERSION 2.1: FIXING NAVIGATION ON WEBPAGE: 

// import React, { useState, useEffect, useRef } from "react";
// import axios from "axios";
// import "./upload.css";
// import logo from "../assets/logo.png";
// import ChatbotInterface from "./ChatbotInterface"; // The chatbot page

// const Documents = () => {
//   // Toggle between ChatbotInterface and Upload UI
//   const [showChatbot, setShowChatbot] = useState(false);

//   // ========== Upload Page State/Logic ==========
//   const [documents, setDocuments] = useState([]);
//   const [showModal, setShowModal] = useState(false); // Upload form modal
//   const [previewModal, setPreviewModal] = useState(false); // File preview modal
...
//   useEffect(() => {
//     // Only fetch documents if we're on the upload page
//     if (!showChatbot) {
//       fetchDocuments();
//     }
//   }, [showChatbot]);
...
//   // If showChatbot === true, show the ChatbotInterface
//   if (showChatbot) {
//     return (
//       <div className="dashboard">
//         <aside className="sidebar">
...
//               <li>Settings</li>
//               <li>Logout</li>
//               {/* This toggles us back to Upload */}
//               <li onClick={() => setShowChatbot(false)} style={{ cursor: "pointer" }}>
//                 Document Upload
//               </li>
//             </ul>
//           </nav>
...
//   // Otherwise, show the Document Upload UI
//   return (
//     <div className="dashboard">
//       {/* Sidebar */}
//       <aside className="sidebar">
...
//           <ul>
//             <li>Medical History</li>
//             {/* This toggles us to the Chatbot */}
//             <li onClick={() => setShowChatbot(true)} style={{ cursor: "pointer" }}>
//               MedAssistant
//             </li>
//             <li>Appointments</li>
...
// const Documents = () => {
//   // Local state – only one document will be shown in the table.
//   const [documents, setDocuments] = useState([]);
//   // Modal visibility
//   const [showModal, setShowModal] = useState(false);
//   // Form fields for new document
...
//   // Add the new document (and for this demo, we only show one document)
//   const handleAddDocument = async () => {
//     if (!docName || !docType || !docFile) {
//       alert("Please enter a name, type, and choose a file.");
//       return;
//     }
//     // (Optional) Upload file to backend – adjust URL and headers as needed.
//     try {
//       const formData = new FormData();
//       formData.append("file", docFile);
//       // Uncomment below to enable actual upload:
//       // const response = await axios.post("http://localhost:5001/upload", formData, {
//       //   headers: { "Content-Type": "multipart/form-data" },
//       // });
//       // console.log(response.data);
...
//       return;
//     }
//     // For display, only show the first document
//     const newDoc = {
//       id: Date.now(),
//       name: docName,
//       type: docType,
...
//   // Dummy view handler – replace with your file retrieval/preview logic
//   const handleViewDocument = (doc) => {
//     alert(`Viewing document: ${doc.name} (${doc.fileName})`);
//   };
...
//           {/* Documents table – only shows one document if available */}
//           <div className="table-container">
//             <table>
//               <thead>
//                 <tr>
...
//       {/* Modal Overlay for Upload Document */}
//       {showModal && (
//         <div className="modal-overlay">
//           <div className="modal-content">
//             <h2>Upload Document</h2>
